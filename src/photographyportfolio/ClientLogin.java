...
public class ClientLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(296, 180, 210, -1));
        ...
        getContentPane().add(username1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 30, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ClientRegistartion  RegistartionFrame = new  ClientRegistartion();
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try {
            ...
            String sql = "select * from clientusers where username = '"+username+"' and password = '"+Password+"';";
            //JOptionPane.showMessageDialog(this, sql);
            java.sql.ResultSet rst = stm .executeQuery(sql);
            if(rst.next()){
                 javax.swing.JOptionPane.showMessageDialog(this, "Login Successfully");
                AdminReview admininfoFrame = new AdminReview();
                admininfoFrame.clientusername.setText(username);
                admininfoFrame.username.setText(username1.getText());
                admininfoFrame.show();
                dispose();
            }else{
