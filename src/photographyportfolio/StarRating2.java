...
public class StarRating2 extends javax.swing.JPanel {
...
//            star3ActionPerformed(null);
        ...
        star1.setForeground(Color.YELLOW);  // Set star color to yellow
    star2.setForeground(Color.GRAY);   // Set the other stars to gray or any other desired color
    star3.setForeground(Color.GRAY);
    star4.setForeground(Color.GRAY);
    star5.setForeground(Color.GRAY);
...
//    star1.setSelected(star >= 1);
//    star2.setSelected(star >= 2);
//    star3.setSelected(star >= 3);
//    star4.setSelected(star >= 4);
//    star5.setSelected(star >= 5);
//
//    star1.setForeground(star >= 1 ? Color.YELLOW : Color.GRAY);
//    star2.setForeground(star >= 2 ? Color.YELLOW : Color.GRAY);
//    star3.setForeground(star >= 3 ? Color.YELLOW : Color.GRAY);
//    star4.setForeground(star >= 4 ? Color.YELLOW : Color.GRAY);
//    star5.setForeground(star >= 5 ? Color.YELLOW : Color.GRAY);
}
...
//        runEvent();
    ...
    public star.rating.Star star1;
    public star.rating.Star star2;
    public star.rating.Star star3;
    public star.rating.Star star4;
    public star.rating.Star star5;
